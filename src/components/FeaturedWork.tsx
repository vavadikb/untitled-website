  ...
  return (
    <section id="work" className="py-20 md:py-32 relative">
      ...
      <AnimatePresence>
        {selectedProject && (
          <motion.div
            className="fixed inset-0 z-[9999] bg-bg-primary overflow-y-auto overflow-x-hidden"
            initial={{ opacity: 0 }}
            animate={{ opacity: 1 }}
            exit={{ opacity: 0 }}
          >
            ...
            <button
              ...
              className="fixed top-6 right-6 md:top-8 md:right-8 z-50 w-10 h-10 rounded-full bg-white/10 backdrop-blur-sm hover:bg-white/20 flex items-center justify-center transition-colors"
            >
